...
const itemBaseData = {
    ...
    "Stopwatch": {name: "Stopwatch", expense: 30000000, effect: 3, description: "Gamespeed"},
...
const itemCategories = {
    ...
    "Misc"                   : ["Book", "Dumbbells", "Personal Squire", "Steel Longsword", "Butler", "Sapphire Charm", "Study Desk", "Library", "Stopwatch", "Observatory", "Mind's Eye", "Void Necklace", "Void Armor", "Void Blade", "Void Orb", "Void Dust", "Celestial Robe", "Universe Fragment", "Multiverse Fragment"]
}
...
gameData.requirements = {
    ...
    "Stopwatch": new CoinRequirement([getItemElement("Stopwatch")], [{requirement: gameData.itemData["Stopwatch"].getExpense() * 100}, {task: "Adept Mage", requirement: 10}]), 
