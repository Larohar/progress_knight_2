...
const itemBaseData = {
    ...
    "Stopwatch": {name: "Stopwatch", expense: 2500, effect: 2, description: "Gamespeed"},
...
const tooltips = {
    ...
    "Stopwatch": "A magic Stopwatch that helps you shave off some seconds from even the most basic of tasks. Or does it?!",
